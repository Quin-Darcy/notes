    ...
    \begin{enumerate}
        ...
        \item[23.6.] Let $A\subset X$. Show that if $C$ is a connected subspace
            ...
            \begin{proof}
                ...
                are a separation of $C$ and therefore $C$ is not connected.
            \end{proof}
        \item[24.1]\hfill\par
            \begin{enumerate}
                \item Show that no two of the spaces $(0, 1)$, $(0, 1]$, $[0,
                    ...
                    \begin{proof}
                        ...
                        1)$ and this would constitute a separation. On the
                        ...
                        a)$ and $V=(a, 1]$ and this forms a separation on
                        ...
                        1). 
                    \end{proof}
                \item[(c)] Show $\mathbb{R}^n$ and $\mathbb{R}$ are not homeomorphic
                    if $n>1$.
                    \begin{proof}
                        ...
                        0)$ and $V=(0, \infty)$ forms a separation on the set.
